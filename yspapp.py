...
def ckey42(Platform, Timestamp, Sdtfrom="v3021", vid="", guid="", appVer="V8.22.1035.3031"):
...
def ysp(cnlid: str, livepid: str, defn: str = "auto", guid: str = None, app_version: str = "3.2.2.23730"):
    try:
        ...
        params ={
            ...
            "newplatform": "4330403",
            "getpreviewinfo": "0",
            "uhd_flag": "2",  # 实际请求中是2，不是4
            "spdrm": "2",
            "adjust": "1",
            "spdynamicrange": "1",
            "appVer": "V8.22.1035.3031",
            "lang": "zh_TW",  # 实际是zh_TW，不是zh-Hans_JP
            "encryptVer": "4.2",
            "spaudio": "1",
            "spflvaudio": "1",
